...
unset($__errorArgs, $__bag); ?>" id="permission-name" name="name" placeholder="e.g., delete posts" value="<?php echo e(old('name')); ?>" required>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Admin\resources\views/permissions/index.blade.php ENDPATH**/ ?>