            ...
            <div class="mt-2">
                <a href="javascript: void(0);" class="d-flex">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="Generic placeholder image" height="36">
                    </div>
                ...
                <a href="javascript: void(0);" class="d-flex">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="Generic placeholder image" height="36">
                    </div>
                    <div class="flex-grow-1 chat-user-box">
                ...
                <a href="javascript: void(0);" class="d-flex">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="Generic placeholder image" height="36">
                    </div>
                    <div class="flex-grow-1 chat-user-box">
                ...
                <a href="javascript: void(0);" class="d-flex">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>" alt="Generic placeholder image" height="36">
                    </div>
                    <div class="flex-grow-1 chat-user-box">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex mb-4">
                        <div class="flex-shrink-0 me-3">
                            <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="Generic placeholder image">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-6">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="Card image cap">
                        ...
                        <div class="col-xl-2 col-6">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="Card image cap">
                                <div class="py-2 text-center">
                                    <a href="javascript: void(0);" class="fw-medium">Download</a>
                                </div>
                            </div>
...
<!-- email editor init -->
<script src="<?php echo e(URL::asset('build/js/pages/email-editor.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/email-read.blade.php ENDPATH**/ ?>