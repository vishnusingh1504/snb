...
<!-- Session timeout js -->
<script src="<?php echo e(URL::asset('build/libs/@curiosityx/bootstrap-session-timeout/index.js')); ?>"></script>

<!-- Session timeout js -->
<script src="<?php echo e(URL::asset('build/js/pages/session-timeout.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/ui-session-timeout.blade.php ENDPATH**/ ?>