...
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="d-flex align-items-center">
            <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm rounded">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div>
                        <img src="<?php echo e(URL::asset('build/images/jobs.png')); ?>" alt="" height="130">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="3000">
                            <div class="bg-light p-3 d-flex mb-3 rounded">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-sm rounded me-3">
                                <div class="flex-grow-1">
                            ...
                            <div class="bg-light p-3 d-flex">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-sm rounded me-3">
                                <div class="flex-grow-1">
                        ...
                        <div class="carousel-item" data-bs-interval="3000">
                            <div class="bg-light p-3 d-flex mb-3 rounded">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm rounded me-3">
                                <div class="flex-grow-1">
                            ...
                            <div class="bg-light p-3 d-flex">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm rounded me-3">
                                <div class="flex-grow-1">
...
<div class="row">
        ...
        <div class="card">
            <div class="card-body p-4">
                <div class="text-center mb-3">
                    <img src="<?php echo e(URL::asset('build/images/companies/airbnb.svg')); ?>" alt="" class="avatar-sm">
    ...
    <div class="col-lg-2">
        <div class="card">
            <div class="card-body p-4">
                <div class="text-center mb-3">
                    <img src="<?php echo e(URL::asset('build/images/companies/mailchimp.svg')); ?>" alt="" class="avatar-sm">
                    <a href="job-details" class="text-body">
    ...
    <div class="col-lg-2">
        <div class="card">
            <div class="card-body p-4">
                <div class="text-center mb-3">
                    <img src="<?php echo e(URL::asset('build/images/companies/reddit.svg')); ?>" alt="" class="avatar-sm">
                    <a href="job-details" class="text-body">
    ...
    <div class="col-lg-2">
        <div class="card">
            <div class="card-body p-4">
                <div class="text-center mb-3">
                    <img src="<?php echo e(URL::asset('build/images/companies/amazon.svg')); ?>" alt="" class="avatar-sm">
                    <a href="job-details" class="text-body">
    ...
    <div class="col-lg-2">
        <div class="card">
            <div class="card-body p-4">
                <div class="text-center mb-3">
                    <img src="<?php echo e(URL::asset('build/images/companies/adobe-photoshop.svg')); ?>" alt="" class="avatar-sm">
                    <a href="job-details" class="text-body">
    ...
    <div class="col-lg-2">
        <div class="card">
            <div class="card-body p-4">
                <div class="text-center mb-3">
                    <img src="<?php echo e(URL::asset('build/images/companies/line.svg')); ?>" alt="" class="avatar-sm">
                    <a href="job-details" class="text-body">
            ...
            <div class="card-body">
                ...
                <div data-simplebar style="max-height: 376px;">
                    <div class="vstack gap-4">
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/wechat.svg')); ?>" alt="" height="40" class="rounded">
                        ...
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/sass.svg')); ?>" alt="" height="40" class="rounded">
                            <div class="ms-2 flex-grow-1">
                        ...
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/adobe.svg')); ?>" alt="" height="40" class="rounded">
                            <div class="ms-2 flex-grow-1">
                        ...
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/airbnb.svg')); ?>" alt="" height="40" class="rounded">
                            <div class="ms-2 flex-grow-1">
                        ...
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/flutter.svg')); ?>" alt="" height="40" class="rounded">
                            <div class="ms-2 flex-grow-1">
                        ...
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/mailchimp.svg')); ?>" alt="" height="40" class="rounded">
                            <div class="ms-2 flex-grow-1">
                                <h6 class="mb-1 font-size-15"><a href="job-details" class="text-body">Marketing Director</a></h6>
                        ...
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/spotify.svg')); ?>" alt="" height="40" class="rounded">
                            <div class="ms-2 flex-grow-1">
                        ...
                        <div class="d-flex">
                            <img src="<?php echo e(URL::asset('build/images/companies/reddit.svg')); ?>" alt="" height="40" class="rounded">
                            <div class="ms-2 flex-grow-1">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/dashboard-job.blade.php ENDPATH**/ ?>