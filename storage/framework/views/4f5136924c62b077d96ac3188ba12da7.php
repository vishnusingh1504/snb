    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="me-3">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm rounded-circle img-thumbnail">
                    </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                                ...
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                                        <div class="align-self-center overflow-hidden me-auto">
                                            <div>
                                ...
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item py-3">
                            <div class="d-flex align-items-start">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar-xs">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="img-fluid d-block rounded-circle">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 100px;"><img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
...
<!-- blog dashboard init -->
<script src="<?php echo e(URL::asset('build/js/pages/dashboard-blog.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/dashboard-blog.blade.php ENDPATH**/ ?>