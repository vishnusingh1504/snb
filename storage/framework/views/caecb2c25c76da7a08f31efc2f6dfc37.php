            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 align-self-center">
                        <div>
                            <img src="<?php echo e(URL::asset('build/images/crypto/features-img/img-1.png')); ?>" alt="" class="img-fluid d-block">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-xs">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="<?php echo e(URL::asset('build/images/companies/img-1.png')); ?>" alt="" height="18">
                                    </span>
                                </div>
                            </div>
                    ...
                    <li class="list-group-item border-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-xs">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="<?php echo e(URL::asset('build/images/companies/img-2.png')); ?>" alt="" height="18">
                                    </span>
                                </div>
                            </div>
                    ...
                    <li class="list-group-item border-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-xs">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="<?php echo e(URL::asset('build/images/companies/img-3.png')); ?>" alt="" height="18">
                                    </span>
                                </div>
                            </div>
...
<!-- crypto dash init js -->
<script src="<?php echo e(URL::asset('build/js/pages/crypto-dashboard.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/dashboard-crypto.blade.php ENDPATH**/ ?>