...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Project_Overview'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-4">
                            <img src="<?php echo e(URL::asset('build/images/companies/img-1.png')); ?>" alt="" class="avatar-sm">
                        </div>
                    ...
                    <p class="text-muted">To an English person, it will seem like simplified English, as a skeptical
                        ...
                        family. Their separate existence is a myth. For science, music, sport, etc,</p>

                    <div class="text-muted mt-4">
                        <p><i class="mdi mdi-chevron-right text-primary me-1"></i> To achieve this, it would be necessary
                        </p>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap">
                            <tbody>
                                <tr>
                                    <td style="width: 50px;"><img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>"
                                ...
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-circle avatar-xs"
                                            alt=""></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 m-0"><a href="javascript: void(0);" class="text-dark">Carl
                                                Mackay</a></h5>
                                    </td>
                                    <td>
                                        <div>
                                ...
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" class="rounded-circle avatar-xs"
                                            alt=""></td>
                                    <td>
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 45px;">
                                        <div class="avatar-sm">
                                            <span
                                                class="avatar-title rounded-circle bg-primary-subtle text-primary font-size-24">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14"><a href="javascript: void(0);" class="text-dark">Veltrix
                                                admin.Zip</a></h5>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex mb-4">
                        <div class="flex-shrink-0 me-3">
                            <img class="d-flex-object rounded-circle avatar-xs" alt=""
                                src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>">
                        </div>
                    ...
                    <div class="d-flex mb-4">
                        <div class="flex-shrink-0 me-3">
                            <img class="d-flex-object rounded-circle avatar-xs" alt=""
                                src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>">
                        </div>
                        <div class="flex-grow-1">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/projects-overview.blade.php ENDPATH**/ ?>