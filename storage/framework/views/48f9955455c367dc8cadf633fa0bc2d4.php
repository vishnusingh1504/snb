...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Users Grid <?php $__env->endSlot(); ?>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="">
                    </div>
    ...
    <div class="row">
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('build/images/users/avatar-7.jpg')); ?>" alt="">
                    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/contacts-grid.blade.php ENDPATH**/ ?>