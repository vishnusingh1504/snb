...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Projects_List'); ?>
            ...
            <div class="">
                <div class="table-responsive">
                    <table class="table project-list-table table-nowrap align-middle table-borderless">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/companies/img-1.png')); ?>" alt="" class="avatar-sm"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/companies/img-2.png')); ?>" alt="" class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/companies/img-3.png')); ?>" alt="" class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/companies/img-4.png')); ?>" alt="" class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/companies/img-5.png')); ?>" alt="" class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                            ...
                            <tr>
                                <td><img src="<?php echo e(URL::asset('build/images/companies/img-6.png')); ?>" alt="" class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/projects-list.blade.php ENDPATH**/ ?>