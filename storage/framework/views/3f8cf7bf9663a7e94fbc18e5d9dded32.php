...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Buttons'); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="javascript:void(0);" class="btn btn-outline-primary active"
                                        aria-current="page">Left</a>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Bootstrap has a base <code>.btn</code> class that sets up basic styles such
                        as padding and content alignment. By default, <code>.btn</code> controls have a transparent border
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Custom sizing with CSS variables</h4>
                    <p class="card-title-desc">You can even roll your own custom sizing with CSS variables:</p>
                    <div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Focus ring</h4>
                    <p class="card-title-desc">Click directly on the link below to see the focus ring in action, or into
                        the example below and then press <kbd>Tab</kbd>.</p>
                    <div>
                        <a href="#!"
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">CSS variables</h4>
                    <p class="card-title-desc">Modify the <code>--bs-focus-ring-*</code> CSS variables as needed to change
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Sass utilities API</h4>
                    <p class="card-title-desc">In addition to <code>.focus-ring</code>, we have several
                        <code>.focus-ring-*</code> utilities to modify the helper class defaults. Modify the color with any
                        of our <a href="https://getbootstrap.com/docs/5.3/customize/color/#theme-colors">theme colors</a>.
                        Note that the light and dark variants may not be visible on all background colors given current
                        color mode support.</p>
                    <div class="row">
                        <div class="col-xl-6">
                            <p><a href="#!"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\snbic-erp\snb\resources\views/ui-buttons.blade.php ENDPATH**/ ?>