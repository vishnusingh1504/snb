            ...
            <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="pen_number" class="form-control" value="{{ $student->pen_number }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Aadhar No</label>
                        <input type="text" name="adhar_no" class="form-control" value="{{ $student->adhar_no }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Caste</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label>Stream</label>
                        <input type="text" name="stream" class="form-control" value="{{ $student->stream }}">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="prev_school" class="form-control" value="{{ $student->prev_school }}">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="father_occu" class="form-control" value="{{ $student->father_occu }}">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="admission_session" class="form-control"
                            value="{{ $student->admission_session }}">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if ($student->image_location)
                            <img src="{{ asset('storage/' . $student->image_location) }}" width="80" class="mt-2">
                        @endif
                    </div>
